...
//	 public static void validateRegistrationDate(Date registrationDate) throws CustomerHandlingException {
//		 Date regDate=sdf.parse(registrationDate);
//			if(regDate.after(now.Date()))
//				throw new CustomerHandlingException("Invalid Registartion Date");
//			System.out.print("");
//       }
